...
public class GamePanel : MonoBehaviour {
    ...
    public void InitProtectBtn()
    {
        ...
        else if (GameData.Instance.curStageState == StageState.GhostState)
        {
            ...
            protectBtn.transform.localPosition = new Vector3(tree.transform.localPosition.x - 100, tree.transform.localPosition.y + 100, tree.transform.localPosition.z);
            protectBtn2.transform.localPosition = new Vector3(tree.transform.localPosition.x + 100, tree.transform.localPosition.y + 100, tree.transform.localPosition.z);
        }
        else if (GameData.Instance.curStageState == StageState.SkeletonState)
        {
            protectBtn.SetActive(true);
